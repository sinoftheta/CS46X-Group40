...
class ParametersView(QGridLayout):
    def __init__(self, parametersModel):
        ...
        self.setInputs()
        self.updateView(self.viewModel)
    ...
    def updateView(self, viewModel):
        self.NN.setValue(viewModel.NN.getData())
        self.NE.setValue(viewModel.NE.getData())
        self.NK.setValue(viewModel.NK.getData())
        self.NB.setValue(viewModel.NB)
        self.KNB.setValue(viewModel.KNB)
        self.PL.setValue(viewModel.PL)
        self.EI.setValue(viewModel.EI)
        self.PCHNG.setValue(viewModel.PCHNG)
        self.BETAP.setValue(viewModel.BETAP)
        self.DIFUSN.setValue(viewModel.DIFUSN)
        self.CLOS1.setValue(viewModel.CLOS1)
        self.DELT.setValue(viewModel.DELT)
        self.CHNG.setValue(viewModel.CHNG)
        self.ITMAX.setValue(viewModel.ITMAX)
        self.ITER1.setValue(viewModel.ITER1)
        self.ITCHNG.setValue(viewModel.ITCHNG)
        self.IGO.setValue(viewModel.IGO)
        self.TYPE.setCurrentIndex(SchemeTypes.index(viewModel.TYPE))
        self.STAT.setCurrentIndex(TransportTypes.index(viewModel.STAT))
        self.STATP.setCurrentIndex(FlowTypes.index(viewModel.STATP))
